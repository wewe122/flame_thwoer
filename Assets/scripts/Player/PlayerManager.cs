    ...
    public class PlayerManager : MonoBehaviourPunCallbacks, IPunObservable
    {
        ...
        public void Update()
        {
            ...
            if (this.beams != null && this.IsFiring != this.beams.activeInHierarchy)
            {
                ...
                if(beams.GetComponent<FireBaseScript>().AudioSource != null)
                    beams.GetComponent<FireBaseScript>().AudioSource.Play();
                foreach (ParticleSystem p in beams.GetComponentsInChildren<ParticleSystem>())
                {
